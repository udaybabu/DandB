...
<spring:url value="<%= URLConstants.USER_UPDATE %>" var="userUpdate"/>
...
<div class="row">
    ...
    <s:form action="${userUpdate}" method="post" commandName="userForm" onsubmit="return validateUser();" >
     <div class="container-fluid">
    ...
    <s:hidden path="userId" id="userId"/>
      <s:hidden path="userTypeId"/>
    <div class="col-lg-3 col-md-3">
	<div class="form-group">
    ...
    <div class="col-lg-3 col-md-3">
     <div class="form-group">
    <label><spring:message code="user.label.usertype"/></label> 
 	<s:input path="userType" id="userType" class="form-control" readonly="true" />
    </div>
    </div>
    <div class="col-lg-3 col-md-3">
    <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3">
    <div class="form-group">
    <label><spring:message code="user.label.password"/></label> 
    ...
    <div class="col-lg-3 col-md-3">
    <div class="form-group">
    <label><spring:message code="user.label.confirmpassword"/></label> 
    ...
    <div class="row">
    <div class="col-lg-12 col-md-12 text-center">
    <button type="submit" id="submit-dis" class="btn btn-submit btn-md" style="border-radius:2px;"><spring:message code="common.button.update"/></button>
    <span>
