...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
 ...
 <spring:url value="<%= URLConstants.TEAM_SAVE %>" var="actionUrl" /> 
...
function validateTeam(){
    ...
    <span class="heading"><spring:message code="team.label.header"/></span>
    </div>
    </div>
    ...
    <s:form action="${actionUrl}" method="post" commandName="teamForm" id="teamForm" onsubmit="return validateTeam();">
    ...
    <s:option value="0"><spring:message code="team.label.select"/></s:option>
    ...
    <label><spring:message code="team.label.selectedMembers"/><sup class="text-danger">*</sup></label>
    <table class="table table-bordered">
    <tbody>
    ...
    <td class="txtCont"><h6><c:out value="${selectedUsers.name}" />
    ...
    <div class="row">
    <div class="col-lg-12 col-md-12 text-center">
    <button type="submit" class="btn btn-md btn-submit"><spring:message code="team.label.create"/></button>
